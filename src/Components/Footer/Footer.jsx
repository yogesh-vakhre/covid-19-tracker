  ...
  const SocialWidget = [
    {
      ...
      ProfileLink: "https://www.linkedin.com/in/yogeshvakhre/",
      fontAwesomeIconName: "fab fa-linkedin",
      OnMouseOverColor: "#4875B4",
    },
    {
      SocialMediaName: "GitHub",
      ProfileLink: "https://github.com/yogeshvakhre",
    ...
    // },
    {
      ...
      ProfileLink: "mailto:yogeshvakhre05@gmail.com",
    ...
    <React.Fragment>
      <div className={styles.container}>
        ...
        >
          ...
          <a
            href="https://github.com/yogesh-vakhre/covid-19-tracker"
            target="_blank"
      ...
      <div className={styles.container}>
        ...
        >
          Data provided by{" "}
          <a
            href="https://github.com/yogesh-vakhre/covid-19-api"
            target="_blank"
            rel="noopener noreferrer"
            style={{ color: "rgba(0,0,255,0.6)", textDecoration: "none" }}
          >
